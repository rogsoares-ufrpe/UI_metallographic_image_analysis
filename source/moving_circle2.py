# -*- coding: utf-8 -*-
"""
Created on Sun May 24 01:05:25 2020
...
class Cross:
    ...
    def __init__(self, window, canvas, center, delta=10):
        ...
        self.coords = [center[0] - delta, center[1], center[0] + delta, center[1], center[0], center[1]+delta,center[0],center[1]-delta]
...
def define_circular_pattern(window, canvas):
    ...
    cross2 = Cross(window, canvas, (x0+100,y0+100))
