...
#    Dec 03, 2023 02:44:10 PM -03  platform: Windows NT
...
class Toplevel_MainWindow:
    def __init__(self, top=None):
        ...
        self.MainCanvas.place(x=10, y=10, height=590, width=800)
        ...
        self.LabelDirectoryPathName.place(x=30, y=630, height=20, width=881)
        ...
        self.Labelframe_metallographic.place(x=830, y=10, height=105, width=432)
        ...
        self.Entry_magnification.configure(cursor="fleur")
        ...
        self.Button_getScale.configure(command=gui_main_2TMP_support.image_data_set)
        ...
        self.TextBox_output.place(x=830, y=120, height=475, width=435)
        ...
        self.menubar.add_cascade(compound='left', label='File', menu=self.sub_menu
                ,)
        self.sub_menu.add_command(command=gui_main_2TMP_support.open_image_file
        ...
        self.sub_menu.add_command(command=gui_main_2TMP_support.close_application
        ...
        self.menubar.add_cascade(compound='left', label='Image analysis'
                ,menu=self.sub_menu1, )
        self.sub_menu1.add_command(command=gui_main_2TMP_support.open_segmentation_panel
        ...
        self.sub_menu12.add_command(command=gui_main_2TMP_support.about
...
class TopLevel_SegmentationWindow:
    def __init__(self, top=None):
        ...
        self.RadioButton_Filter_None.configure(command=gui_main_2TMP_support.select_filter)
        ...
        self.RadioButton_Filter_GaussianBlur.configure(command=gui_main_2TMP_support.select_filter)
        ...
        self.RadioButton_Filter_2DConvolution.configure(command=gui_main_2TMP_support.select_filter)
        ...
        self.Radiobutton_Filter_Bilateral.configure(command=gui_main_2TMP_support.select_filter)
        ...
        self.Radiobutton_Filter_MedianBlur.configure(command=gui_main_2TMP_support.select_filter)
        ...
        self.Radiobutton_Filter_Laplacian.configure(command=gui_main_2TMP_support.select_filter)
        ...
        self.Radiobutton_Averaging.configure(command=gui_main_2TMP_support.select_filter)
        ...
        self.Button_DetectStructure.place(x=230, y=210, height=44, width=151
                , bordermode='ignore')
        ...
        self.Button_DetectStructure.configure(command=gui_main_2TMP_support.select_structure_type)
        ...
        self.Button_DetectStructure.configure(text='''Select detection''')
        self.Labelframe_Edgedetection = tk.LabelFrame(self.LabelFrame_Segmentation)
        self.Labelframe_Edgedetection.place(x=160, y=20, height=95, width=240
                , bordermode='ignore')
        ...
        self.Radiobutton_Canny = tk.Radiobutton(self.Labelframe_Edgedetection)
        self.Radiobutton_Canny.place(x=10, y=20, height=25, width=62
                , bordermode='ignore')
        self.Radiobutton_Canny.configure(activebackground="beige")
        self.Radiobutton_Canny.configure(activeforeground="black")
        self.Radiobutton_Canny.configure(anchor='w')
        self.Radiobutton_Canny.configure(background="#d9d9d9")
        self.Radiobutton_Canny.configure(compound='left')
        self.Radiobutton_Canny.configure(disabledforeground="#a3a3a3")
        self.Radiobutton_Canny.configure(foreground="#000000")
        self.Radiobutton_Canny.configure(highlightbackground="#ffff80")
        self.Radiobutton_Canny.configure(highlightcolor="black")
        self.Radiobutton_Canny.configure(justify='left')
        self.Radiobutton_Canny.configure(selectcolor="#d9d9d9")
        self.Radiobutton_Canny.configure(text='''Canny''')
        self.Radiobutton_Canny.configure(value='1')
        self.Radiobutton_Canny.configure(variable=self.rb_edgedetection)
        self.Radiobutton_Canny_tooltip = \
        ToolTip(self.Radiobutton_Canny, '''The function finds edges in the input image and marks them in the output map edges using the Canny algorithm. The smallest value between threshold1 and threshold2 is used for edge linking. The largest value is used to find initial segments of strong edges.''')

        self.Radiobutton_Sobel = tk.Radiobutton(self.Labelframe_Edgedetection)
        self.Radiobutton_Sobel.place(x=10, y=40, height=25, width=57
                , bordermode='ignore')
        self.Radiobutton_Sobel.configure(activebackground="beige")
        self.Radiobutton_Sobel.configure(activeforeground="black")
        self.Radiobutton_Sobel.configure(anchor='w')
        self.Radiobutton_Sobel.configure(background="#d9d9d9")
        self.Radiobutton_Sobel.configure(compound='left')
        self.Radiobutton_Sobel.configure(disabledforeground="#a3a3a3")
        self.Radiobutton_Sobel.configure(foreground="#000000")
        self.Radiobutton_Sobel.configure(highlightbackground="#d9d9d9")
        self.Radiobutton_Sobel.configure(highlightcolor="black")
        self.Radiobutton_Sobel.configure(justify='left')
        self.Radiobutton_Sobel.configure(selectcolor="#d9d9d9")
        self.Radiobutton_Sobel.configure(text='''Sobel''')
        self.Radiobutton_Sobel.configure(value='2')
        self.Radiobutton_Sobel.configure(variable=self.rb_edgedetection)
        self.Radiobutton_Prewitt = tk.Radiobutton(self.Labelframe_Edgedetection)
        self.Radiobutton_Prewitt.place(x=10, y=60, height=25, width=65
                , bordermode='ignore')
        self.Radiobutton_Prewitt.configure(activebackground="beige")
        self.Radiobutton_Prewitt.configure(activeforeground="black")
        self.Radiobutton_Prewitt.configure(anchor='w')
        self.Radiobutton_Prewitt.configure(background="#d9d9d9")
        self.Radiobutton_Prewitt.configure(compound='left')
        self.Radiobutton_Prewitt.configure(disabledforeground="#a3a3a3")
        self.Radiobutton_Prewitt.configure(foreground="#000000")
        self.Radiobutton_Prewitt.configure(highlightbackground="#d9d9d9")
        self.Radiobutton_Prewitt.configure(highlightcolor="black")
        self.Radiobutton_Prewitt.configure(justify='left')
        self.Radiobutton_Prewitt.configure(selectcolor="#d9d9d9")
        self.Radiobutton_Prewitt.configure(text='''Prewitt''')
        self.Radiobutton_Prewitt.configure(value='3')
        self.Radiobutton_Prewitt.configure(variable=self.rb_edgedetection)
        _style_code()
        self.EdgeDetectionMethods_ComboBox = ttk.Combobox(self.Labelframe_Edgedetection)
        self.EdgeDetectionMethods_ComboBox.place(x=80, y=20, height=21, width=143
                , bordermode='ignore')
        self.value_list = ['Canny,',]
        self.EdgeDetectionMethods_ComboBox.configure(values=self.value_list)
        self.EdgeDetectionMethods_ComboBox.configure(textvariable=self.combobox)
        self.EdgeDetectionMethods_ComboBox.configure(takefocus="")
        self.lab47_lab48 = tk.LabelFrame(self.LabelFrame_Segmentation)
        self.lab47_lab48.place(x=160, y=120, height=75, width=240
                , bordermode='ignore')
        ...
        self.lab47_lab48_tCo53 = ttk.Combobox(self.lab47_lab48)
        self.lab47_lab48_tCo53.place(x=20, y=20, height=21, width=143
                , bordermode='ignore')
        self.lab47_lab48_tCo53.configure(textvariable=self.combobox)
        self.lab47_lab48_tCo53.configure(takefocus="")
