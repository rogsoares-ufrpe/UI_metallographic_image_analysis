...
class MainWindow:
    def __init__(self, top=None):
        ...
        self.sub_menu.add_command(
                ...
                activeforeground="#000000",
                background="#d9d9d9",
                command=gui_main_support.load_image_analysis,
                font="TkMenuFont",
                foreground="#000000",
                label="Load Image Analysis")
        self.sub_menu.add_command(
                activebackground="#ececec",
                activeforeground="#000000",
                background="#d9d9d9",
                font="TkMenuFont",
                foreground="#000000",
                label="Save Image Analysis",
                command=gui_main_support.save_image_analysis)
        ...
        # open a sub-menu for image filters
        self.SM_Image_Filters = tk.Menu(top,tearoff=0)
        self.menubar.add_cascade(menu=self.SM_Image_Filters,
                activebackground="#ececec",
                activeforeground="#000000",
                background="#d9d9d9",
                font="TkMenuFont",
        ...
        self.SM_Image_Filters.add_command(
                activebackground="#ececec",
                activeforeground="#000000",
                background="#d9d9d9",
                font="TkMenuFont",
                foreground="#000000",
                label="None (default)",
                command=lambda: gui_main_support.image_filter("None"))
        ...
        self.SM_Image_Filters.add_command(
                ...
                foreground="#000000",
                label="Gaussian Blur",
                command=lambda: gui_main_support.image_filter("Gaussian blur"))
        ...
        self.SM_Image_Filters.add_command(
                ...
                command=lambda: gui_main_support.image_filter("2D convolution"))
        ...
        self.SM_Image_Filters.add_command(
                ...
                font="TkMenuFont",
                foreground="#000000",
                label="Median Blurring",
                command=lambda: gui_main_support.image_filter("Median Blurring"))
        ...
        self.SM_Image_Filters.add_command(
                ...
                command=lambda: gui_main_support.image_filter("Bilateral Filter"))
        ...
        self.SM_Image_Filters.add_command(
                ...
                foreground="#000000",
                label="Averaging",
                command=lambda: gui_main_support.image_filter("Averaging"))
        ...
        self.SM_Image_Filters.add_command(
                ...
                command=lambda: gui_main_support.image_filter("HistogramEqualization"))
        ...
        self.sub_menu1.add_command(
                ...
                foreground="#000000",
                label="Phases",
                command=gui_main_support.metallografic_phases_analysis)
        # self.sub_menu1.add_command(
        #         activebackground="#ececec",
        #         activeforeground="#000000",
        #         background="#d9d9d9",
        #         font="TkMenuFont",
        #         foreground="#000000",
        #         command=gui_main_support.pickup_pixel,
        #         label="Pick pixel value")
        self.sub_menu1.add_command(
                activebackground="#ececec",
                activeforeground="#000000",
                background="#d9d9d9",
                command=gui_main_support.insert_circular_pattern,
                font="TkMenuFont",
                foreground="#000000",
        ...
        ToolTip(self.RB_Procedure_Planimetric, tooltip_font, '''It involves an actual count of the number of grains within a known'''
                                                             '''area. The number of grains per unit area, NA , is used to determine the ASTM grain size number, G.''', delay=0.5)
        ...
        self.Label3.configure(text=u'''\u03BC'''+'''m''')
        ...
        self.RBtn_millimeters.configure(text=u'''\u03BC'''+'''m''')
