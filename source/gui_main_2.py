...
#    Mar 20, 2024 12:10:43 PM -03  platform: Windows NT
...
class Toplevel_MainWindow:
    def __init__(self, top=None):
        ...
        self.MainFrame.place(x=10, y=10, height=660, width=1269)
        ...
        self.TextBox_output.place(x=810, y=10, height=275, width=450)
        ...
        self.Label_coords.configure(font="-family {Segoe UI} -size 9")
        ...
        self.CanvasHistogram.place(x=810, y=290, height=313, width=450)
...
class TopLevel_MeasuringProcedure:
    def __init__(self, top=None):
        ...
        self.numlines = tk.StringVar()
        self.RB_procedure = tk.IntVar()

        self.ApplyProcudureButton = tk.Button(self.top)
        self.ApplyProcudureButton.place(x=270, y=240, height=34, width=137)
        ...
        self.fra66.place(x=10, y=10, height=215, width=315)
        ...
        self.RB_HeynsP.place(x=10, y=90, height=25, width=210)
        ...
        self.fra66_fra56 = tk.Frame(self.fra66)
        self.fra66_fra56.place(x=30, y=40, height=45, width=175)
        self.fra66_fra56.configure(relief='groove')
        self.fra66_fra56.configure(borderwidth="2")
        self.fra66_fra56.configure(relief="groove")
        self.fra66_fra56.configure(background="#d9d9d9")
        self.fra66_fra56.configure(highlightbackground="#d9d9d9")
        self.fra66_fra56.configure(highlightcolor="#000000")

        self.JeffriesAreaLabel = tk.Label(self.fra66_fra56)
        self.JeffriesAreaLabel.place(x=10, y=10, height=21, width=105)
        self.JeffriesAreaLabel.configure(activebackground="#d9d9d9")
        self.JeffriesAreaLabel.configure(activeforeground="black")
        self.JeffriesAreaLabel.configure(anchor='w')
        self.JeffriesAreaLabel.configure(background="#d9d9d9")
        self.JeffriesAreaLabel.configure(compound='left')
        self.JeffriesAreaLabel.configure(disabledforeground="#a3a3a3")
        self.JeffriesAreaLabel.configure(font="-family {Segoe UI} -size 9")
        self.JeffriesAreaLabel.configure(foreground="#000000")
        self.JeffriesAreaLabel.configure(highlightbackground="#d9d9d9")
        self.JeffriesAreaLabel.configure(highlightcolor="#000000")
        self.JeffriesAreaLabel.configure(text='''Circunference area''')
        

        self.CircunferenceJeffriesArea = tk.Entry(self.fra66_fra56)
        self.CircunferenceJeffriesArea.place(x=120, y=10, height=20, width=42)
        ...
        # self.CircunferenceJeffriesArea.insert("5000")

        self.fra66_fra58 = tk.Frame(self.fra66)
        self.fra66_fra58.place(x=30, y=120, height=75, width=175)
        self.fra66_fra58.configure(relief='groove')
        self.fra66_fra58.configure(borderwidth="2")
        self.fra66_fra58.configure(relief="groove")
        self.fra66_fra58.configure(background="#d9d9d9")
        self.fra66_fra58.configure(highlightbackground="#d9d9d9")
        self.fra66_fra58.configure(highlightcolor="#000000")

        self.LineLengthLabel = tk.Label(self.fra66_fra58)
        self.LineLengthLabel.place(x=10, y=40, height=21, width=70)
        self.LineLengthLabel.configure(activebackground="#d9d9d9")
        self.LineLengthLabel.configure(activeforeground="black")
        self.LineLengthLabel.configure(anchor='w')
        self.LineLengthLabel.configure(background="#d9d9d9")
        self.LineLengthLabel.configure(compound='left')
        self.LineLengthLabel.configure(disabledforeground="#a3a3a3")
        self.LineLengthLabel.configure(font="-family {Segoe UI} -size 9")
        self.LineLengthLabel.configure(foreground="#000000")
        self.LineLengthLabel.configure(highlightbackground="#d9d9d9")
        self.LineLengthLabel.configure(highlightcolor="#000000")
        self.LineLengthLabel.configure(text='''Lines length''')

        self.LabelNumberofLines = tk.Label(self.fra66_fra58)
        self.LabelNumberofLines.place(x=10, y=10, height=21, width=91)
        self.LabelNumberofLines.configure(activebackground="#d9d9d9")
        self.LabelNumberofLines.configure(activeforeground="black")
        self.LabelNumberofLines.configure(anchor='w')
        self.LabelNumberofLines.configure(background="#d9d9d9")
        self.LabelNumberofLines.configure(compound='left')
        self.LabelNumberofLines.configure(disabledforeground="#a3a3a3")
        self.LabelNumberofLines.configure(font="-family {Segoe UI} -size 9")
        self.LabelNumberofLines.configure(foreground="#000000")
        self.LabelNumberofLines.configure(highlightbackground="#d9d9d9")
        self.LabelNumberofLines.configure(highlightcolor="#000000")
        self.LabelNumberofLines.configure(text='''Number of lines''')

        self.NumLinesHeyns = tk.Entry(self.fra66_fra58)
        self.NumLinesHeyns.place(x=110, y=10, height=20, width=42)
        ...
        self.NumLinesHeyns.configure(textvariable=self.numlines)
        self.NumLinesHeyns_tooltip = \
        ToolTip(self.NumLinesHeyns, '''Provide the number of lines to be intercepted by grains''')

        self.LineLength = tk.Entry(self.fra66_fra58)
        self.LineLength.place(x=110, y=40, height=20, width=42)
        ...
        self.LineLength_tooltip = \
        ToolTip(self.LineLength, '''Provide the line length em um''')
