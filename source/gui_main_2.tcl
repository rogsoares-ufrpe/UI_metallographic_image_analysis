...
proc vTclWindow.top1 {base} {
    ...
    wm geometry $top 1284x620+137+11
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
...
set site_3_0 $top.m53
    ...
    frame "$top.fra47" \
        -borderwidth 2 -relief groove -background #d9d9d9 -height 660 \
        -highlightbackground #d9d9d9 -highlightcolor #000000 -width 1269 
    ...
    canvas "$site_3_0.can48" \
        -background #d9d9d9 -borderwidth 2 -closeenough 1.0 -height 590 \
        -highlightbackground #d9d9d9 -highlightcolor #000000 \
        -insertbackground #000000 -relief ridge -selectbackground #c4c4c4 \
    ...
    place $site_3_0.scr48 \
        -in $site_3_0 -x 810 -y 10 -width 450 -relwidth 0 -height 275 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.lab47 \
        -in $site_3_0 -x 685 -y 610 -anchor nw -bordermode ignore 
    place $site_3_0.can60 \
        -in $site_3_0 -x 810 -y 290 -width 450 -relwidth 0 -height 313 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.can48 \
        -in $site_3_0 -x 10 -y 10 -width 800 -relwidth 0 -height 590 \
        -relheight 0 -anchor nw -bordermode ignore 
    ###################
    # SETTING GEOMETRY
    ###################
    place $top.fra47 \
        -in $top -x 10 -y 10 -width 1269 -relwidth 0 -height 660 -relheight 0 \
...
proc vTclWindow.top2 {base} {
    ...
    vTcl::widgets::core::toplevel::createCmd $top -class Toplevel \
        ...
        -highlightcolor #000000 
    wm focusmodel $top passive
    wm geometry $top 517x225+363+93
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
...
proc vTclWindow.top3 {base} {
    ...
    vTcl::widgets::core::toplevel::createCmd $top -class Toplevel \
        ...
        -highlightcolor #000000 
    wm focusmodel $top passive
    wm geometry $top 329x92+886+380
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
...
proc vTclWindow.top4 {base} {
    ...
    vTcl::widgets::core::toplevel::createCmd $top -class Toplevel \
        ...
        -highlightcolor #000000 
    wm focusmodel $top passive
    wm geometry $top 678x288+311+149
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
    ...
    wm resizable $top 1 1
    wm deiconify $top
    set toptitle "Determining Average Grain Size - ASTM/E112-12"
    wm title $top $toptitle
    namespace eval ::widgets::${top}::ClassOption {}
    set ::widgets::${top}::ClassOption(-toptitle) $toptitle
    ...
    frame "$top.fra66" \
        ...
        -highlightbackground #d9d9d9 -highlightcolor #000000 -width 315 
    ...
    label "$site_4_0.lab63" \
        ...
        -font "-family {Segoe UI} -size 9" -foreground #000000 \
        -highlightbackground #d9d9d9 -highlightcolor #000000 \
        -text "Circunference area" 
    vTcl:DefineAlias "$site_4_0.lab63" "JeffriesAreaLabel" vTcl:WidgetProc "TopLevel_MeasuringProcedure" 1
    ...
    vTcl:DefineAlias "$site_4_0.ent64" "CircunferenceJeffriesArea" vTcl:WidgetProc "TopLevel_MeasuringProcedure" 1
    place $site_4_0.lab63 \
        -in $site_4_0 -x 10 -y 10 -anchor nw -bordermode ignore 
    place $site_4_0.ent64 \
        -in $site_4_0 -x 120 -y 10 -width 42 -relwidth 0 -anchor nw \
        -bordermode ignore 
    ...
    label "$site_4_0.lab61" \
        ...
        -highlightbackground #d9d9d9 -highlightcolor #000000 \
        -text "Lines length" 
    vTcl:DefineAlias "$site_4_0.lab61" "LineLengthLabel" vTcl:WidgetProc "TopLevel_MeasuringProcedure" 1
    ...
    vTcl:DefineAlias "$site_4_0.lab59" "LabelNumberofLines" vTcl:WidgetProc "TopLevel_MeasuringProcedure" 1
    entry "$site_4_0.ent60" \
        -background white -disabledforeground #a3a3a3 \
        -font "-family {Courier New} -size 10" -foreground #000000 \
        -highlightbackground #d9d9d9 -highlightcolor #000000 \
        -insertbackground #000000 -selectbackground #d9d9d9 \
        -selectforeground black -textvariable "numlines" -width 10 
    vTcl:DefineAlias "$site_4_0.ent60" "NumLinesHeyns" vTcl:WidgetProc "TopLevel_MeasuringProcedure" 1
    bind $site_4_0.ent60 <<SetBalloon>> {
        set ::vTcl::balloon::%W {Provide the number of lines to be intercepted by grains}
    }
    entry "$site_4_0.ent62" \
        ...
        -insertbackground #000000 -selectbackground #d9d9d9 \
        -selectforeground black -width 10 
    vTcl:DefineAlias "$site_4_0.ent62" "LineLength" vTcl:WidgetProc "TopLevel_MeasuringProcedure" 1
    bind $site_4_0.ent62 <<SetBalloon>> {
        set ::vTcl::balloon::%W {Provide the line length em um}
    }
    ...
    place $site_4_0.ent60 \
        -in $site_4_0 -x 110 -y 10 -width 42 -relwidth 0 -height 20 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_4_0.ent62 \
        -in $site_4_0 -x 110 -y 40 -width 42 -relwidth 0 -height 20 \
        -relheight 0 -anchor nw -bordermode ignore 
    ...
    place $site_3_0.fra56 \
        -in $site_3_0 -x 30 -y 40 -width 175 -relwidth 0 -height 45 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.fra58 \
        -in $site_3_0 -x 30 -y 120 -width 175 -relwidth 0 -height 75 \
        -relheight 0 -anchor nw -bordermode ignore 
    ###################
    # SETTING GEOMETRY
    ###################
    place $top.but57 \
        -in $top -x 270 -y 240 -width 137 -relwidth 0 -height 34 -relheight 0 \
        -anchor nw -bordermode ignore 
    place $top.fra66 \
        -in $top -x 10 -y 10 -width 315 -relwidth 0 -height 215 -relheight 0 \
        -anchor nw -bordermode ignore 
