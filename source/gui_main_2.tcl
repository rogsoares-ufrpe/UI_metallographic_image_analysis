...
proc vTclWindow.top1 {base} {
    ...
    wm geometry $top 1284x680+137+11
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
...
proc vTclWindow.top2 {base} {
    ...
    vTcl::widgets::core::toplevel::createCmd $top -class Toplevel \
        ...
        -highlightcolor #000000 
    wm focusmodel $top passive
    wm geometry $top 517x225+731+26
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
...
proc vTclWindow.top4 {base} {
    ...
    vTcl::widgets::core::toplevel::createCmd $top -class Toplevel \
        ...
        -highlightcolor #000000 
    wm focusmodel $top passive
    wm geometry $top 454x180+242+230
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
    ...
    button "$top.but57" \
        ...
        -text "Apply" 
    vTcl:DefineAlias "$top.but57" "BUtton_ApplyProcudure" vTcl:WidgetProc "TopLevel_MeasuringProcedure" 1
    label "$top.lab64" \
        -activebackground #f9f9f9 -activeforeground black -anchor w \
        -background #d9d9d9 -compound left -disabledforeground #a3a3a3 \
        -font "-family {Segoe UI} -size 9" -foreground #000000 \
    ...
    vTcl:DefineAlias "$top.lab64" "LabelChooseProcedure" vTcl:WidgetProc "TopLevel_MeasuringProcedure" 1
    ttk::style map TCombobox -background  [list !disabled #d9d9d9 disabled #d9d9d9]  -arrowcolor  [list disabled #000000 !disabled #d9d9d9]
    ttk::combobox "$top.tCo65" \
        -values "Jeffries Heyn Hilliard Abram" \
        -font "-family {Segoe UI} -size 9" -textvariable "procedure_var" 
    frame "$top.fra66" \
    ...
    button "$top.but67" \
        ...
        -highlightbackground #d9d9d9 -highlightcolor #000000 -pady 0 \
        -text "Button" 
    vTcl:DefineAlias "$top.but67" "ButtonCloseProcedureWindow" vTcl:WidgetProc "TopLevel_MeasuringProcedure" 1
    ###################
    # SETTING GEOMETRY
    ###################
    place $top.but57 \
        -in $top -x 290 -y 40 -width 137 -relwidth 0 -height 34 -relheight 0 \
        -anchor nw -bordermode ignore 
    place $top.lab64 \
    ...
    place $top.fra66 \
        -in $top -x 10 -y 40 -width 265 -relwidth 0 -height 135 -relheight 0 \
        -anchor nw -bordermode ignore 
    place $top.but67 \
        -in $top -x 290 -y 80 -width 137 -relwidth 0 -height 34 -relheight 0 \
        -anchor nw -bordermode ignore 
